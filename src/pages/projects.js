...
const FeaturedProject = ({ type, title, summary, image, link, github }) => {
    return (
        <article className='w-full p-12 flex items-center justify-between rounded-3xl border border-solid rounded-br-2xl border-dark bg-light shadow-2xl relative'>
            <div className='absolute rounded-br-3xl top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark' />
